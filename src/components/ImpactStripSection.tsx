                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div
                      ...
                      style={{
                        background: `${metric.color.replace("hsl(", "hsla(").replace(")", ", 0.12)")}`,
                      }}
                    >
                      <metric.icon
                        className="w-4 h-4"
                  ...
                  />
                  <p
                    className={`text-sm font-semibold text-foreground mt-2 ${isRTL ? "font-arabic" : "font-heading"}`}
                  >
                    {metric.label}
                  </p>
                  <p
                    className={`text-xs text-muted-foreground mt-1 leading-snug ${isRTL ? "font-arabic" : ""}`}
                  >
                    {metric.description}
                  </p>
                  ...
                  <div className="mt-4 h-1.5 w-full rounded-full bg-muted overflow-hidden">
                    <motion.div
                      ...
                      style={{
                        background: `linear-gradient(90deg, ${metric.color}, ${metric.color.replace("hsl(", "hsla(").replace(")", ", 0.5)")})`,
                      }}
                      initial={{ width: 0 }}
