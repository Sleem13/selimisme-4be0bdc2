        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-heading text-sm font-semibold text-white transition-all duration-300 hover:shadow-[0_0_25px_rgba(6,182,212,0.3)]"
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-white/10 text-gray-300 font-heading text-sm font-medium hover:border-cyan-400/40 hover:text-white transition-all duration-300"
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-white/10 text-gray-300 font-heading text-sm font-medium hover:border-violet-400/40 hover:text-white transition-all duration-300"
              style={{ background: "rgba(10, 15, 30, 0.5)", backdropFilter: "blur(12px)" }}
            >
