...
const milestones: Milestone[] = [
  ...
  },
  {
    ...
    icon: Activity,
    detail:
      "Rotated through musculoskeletal and neuro units. First exposure to messy clinical record-keeping that would later define my analytics work.",
    metric: "120+",
  ...
  },
  {
    ...
    icon: Stethoscope,
    detail:
      "Treated musculoskeletal, neuromuscular, and pediatric cases. Started tracking outcomes in spreadsheets — the seed of every dashboard since.",
    metric: "300+",
  ...
  },
  {
    ...
    icon: BarChart3,
    detail:
      "Built first KPI dashboards for a small clinic. Recovery-time tracking exposed bottlenecks invisible to the human eye.",
    metric: "22%",
  ...
  },
  {
    ...
    icon: Database,
    detail:
      "Designed ETL pipelines and Power BI dashboards for outpatient clinics. Standardized intake → outcome reporting end-to-end.",
    metric: "20+",
  ...
  },
  {
    ...
    icon: BrainCircuit,
    detail:
      "scikit-learn classifiers for readmission risk and recovery trajectories. Shipped models with clinician-readable explanations.",
    metric: "0.87",
  ...
  },
  {
    ...
    icon: LineChart,
    detail:
      "Tableau + Power BI architectures for healthcare and ops clients. Translated KPIs into decisions, not just charts.",
    metric: "8",
  ...
  },
  {
    ...
    icon: Rocket,
    detail:
      "Bridging clinicians and data with measurable impact. Turning chaos into clarity, one pipeline at a time.",
    metric: "∞",
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(180deg, hsl(var(--primary)), hsl(var(--gold)), hsl(var(--soft-green)))",
              }}
              initial={{ scaleY: 0 }}
                  ...
                  >
                    ...
                    <div className="absolute left-4 md:left-1/2 top-6 md:top-1/2 -translate-x-1/2 md:-translate-y-1/2 z-10">
                      <motion.div
                        ...
                        style={{
                          background: m.color,
                          boxShadow: `0 0 0 4px hsl(var(--background)), 0 0 20px ${m.color}`,
                        }}
                    ...
                    >
                      <div
                        ...
                        style={{
                          color: m.color,
                          borderColor: `${m.color.replace("hsl(", "hsla(").replace(")", ", 0.3)")}`,
                          background: `${m.color.replace("hsl(", "hsla(").replace(")", ", 0.08)")}`,
                        }}
                      >
                        {m.year}
                      </div>
                      ...
                      >
                        <div
                          className={`flex items-center gap-3 mb-2 ${isLeft ? "md:flex-row-reverse" : ""}`}
                        >
                          <div
                            className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0"
                            style={{
                              background: `${m.color.replace("hsl(", "hsla(").replace(")", ", 0.12)")}`,
                            }}
                          >
                            <m.icon
                              className="w-5 h-5"
                        ...
                        <p
                          className={`text-xs uppercase tracking-[0.18em] text-muted-foreground/80 mb-3 ${isLeft ? "md:text-right" : ""}`}
                        >
                          {m.company}
                        </p>
                        ...
                        <div
                          className={`flex items-baseline gap-2 ${isLeft ? "md:justify-end" : ""}`}
                        >
                          <span
