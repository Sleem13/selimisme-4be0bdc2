        ...
        <div className="max-w-4xl mx-auto px-8 py-12 print:py-16">
          ...
          <div className="mb-12 border-b-4 border-blue-600 pb-8">
            ...
            <p className="text-lg text-gray-600 mt-2">
              Licensed PT turned ML Engineer | Turning Clinical Chaos into
          ...
          <div className="mb-12 pb-8 border-b-2 border-gray-300 print:border-b-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <p className="font-bold text-black mb-3 text-lg">
                  ML & Analytics
                </p>
          ...
          <div className="mb-12 pb-8 border-b-2 border-gray-300 print:border-b-2">
            ...
            <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
              <p>
                ...
                I've managed 300+ patient cases as a licensed PT. I understand
                the bottlenecks from the inside.
              </p>
              <p>
                <span className="font-bold text-black">
                  End-to-End Builder:
                </span>{" "}
                From raw data to deployed model to clinician dashboard. I ship
                complete systems, not just notebooks.
              </p>
              <p>
                <span className="font-bold text-black">Measurable Impact:</span>{" "}
                Every project I touch has a number attached. 22% faster recovery
                ID. 18% fewer misdiagnoses. 20+ hrs saved weekly.
              </p>
              <p>
                <span className="font-bold text-black">Responsible AI:</span> My
                models undergo fairness audits (Aequitas), explainability checks
                (SHAP), and production monitoring (Evidently AI). Not a black
                box.
              </p>
            </div>
          </div>
          ...
          <div className="mb-12 pb-8 border-b-2 border-gray-300 print:border-b-2">
            ...
            <ul className="space-y-3 text-lg text-gray-700">
              <li>
                <span className="font-bold text-black">🏥 Healthcare ML:</span>{" "}
                Predictive models for patient outcomes, resource allocation, and
                risk stratification
              </li>
              <li>
                <span className="font-bold text-black">
                ...
                ETL pipelines consolidating fragmented clinical data into
                unified dashboards
              </li>
              <li>
                <span className="font-bold text-black">
                ...
                Enabling teams to build on top of LLMs and RAG systems safely
              </li>
              <li>
                <span className="font-bold text-black">
                  📈 Training & Enablement:
                </span>{" "}
                Teaching non-technical teams to ask the right questions of their
                data
              </li>
            </ul>
          </div>
          ...
          <div className="mt-12 pt-8 border-t-2 border-gray-300 text-center text-gray-700 text-sm">
            ...
            <p className="mt-2 font-semibold text-black">
              +20 100 123 4567 · muhammadsleem03@gmail.com
            </p>
          </div>
        </div>
      </div>
